    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-light">
                <h1 class="h3 mb-0">Xem Ngày Cầu an - làm phúc - phóng sinh</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('phong-sinh.check') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="wedding_date_range" class="form-label">dự kiến thời gian cầu an - làm phúc - Phóng sinh</label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card p-4 ">
                                            ...
                                            <ul>
                                                ...
                                                <li>Dự kiến thời gian cầu an - làm phúc - phóng sinh: Trong khoảng {{$date_start_end[0]}} đến {{$date_start_end[1]}} </li>
                                            </ul>
