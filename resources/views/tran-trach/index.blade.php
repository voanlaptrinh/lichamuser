    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-light">
                <h1 class="h3 mb-0">Xem Ngày yểm trấn - trấn trạch</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('tran-trach.check') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="wedding_date_range" class="form-label">dự kiến thời gian yểm trấn - trấn trạch</label>
