    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-light">
                <h1 class="h3 mb-0">XEM HƯỚNG BÀN LÀM VIỆC</h1>
            </div>
            <div class="card-body">
                  <p>Chọn hướng bàn làm việc hợp tuổi giúp đầu óc minh mẫn, công việc hanh thông, sự nghiệp thăng tiến và tài lộc dồi dào.</p>
                {{-- Form này đã đúng, chỉ cần đảm bảo route name là chính xác --}}
                <form action="{{ route('huong-ban-lam-viec.check') }}" method="POST">
                    @csrf
                    <div class="row">
        ...
        @if (isset($results))
            <div class="results-container">
                <h2 class="h4 mb-3">Kết quả xem hướng bàn làm việc cho {{ $results['basicInfo']['gioiTinh'] }} sinh ngày
                ...
                <h6>NHỮNG ĐIỀU CẦN LƯU Ý KHI ĐẶT BÀN LÀM VIỆC</h6>
                <p>Việc kê giường ngủ không đúng cách có thể ảnh hưởng xấu đến sức khỏe, tinh thần, hôn nhân và tài vận. Dưới đây là những điều cấm kỵ cần tránh:</p>
                <div>
