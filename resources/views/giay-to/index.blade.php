    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-light">
                <h1 class="h3 mb-0">Xem Ngày làm giấy tờ - cccd, hộ chiếu</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('giay-to.check') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="wedding_date_range" class="form-label">dự kiến thời gian làm giấy tờ - cccd, hộ chiếu</label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card p-4 ">
                                            ...
                                            <ul>
                                                ...
                                                <li>Dự kiến thời gian làm giấy tờ - CCCD, hộ chiếu: Trong khoảng
