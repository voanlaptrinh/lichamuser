    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-light">
                <h1 class="h3 mb-0">Xem Ngày Thi cử - phỏng vấn</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('thi-cu.check') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="wedding_date_range" class="form-label">dự kiến thời gian thi cử - phỏng vấn</label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card p-4 ">
                                            ...
                                            <ul>
                                                ...
                                                <li> Dự kiến thời gian thi cử - phỏng vấn: Trong khoảng
