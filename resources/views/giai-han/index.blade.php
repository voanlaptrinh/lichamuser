    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-light">
                <h1 class="h3 mb-0">Xem Ngày Cúng sao - giải hạn</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('giai-han.check') }}" method="POST">
                    @csrf
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card p-4 ">
                                            ...
                                            <ul>
                                                ...
                                                <li>Dự kiến cúng sao giải hạn: Trong khoảng {{$date_start_end[0]}} đến {{$date_start_end[1]}} </li>
                                            </ul>
