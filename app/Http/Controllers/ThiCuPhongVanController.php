...
class ThiCuPhongVanController extends Controller
{
     /**
     * Hiển thị form xem ngày thi cử phỏng vấn.
     */
    ...
    public function checkDays(Request $request)
    {
        ...
        $purpose = 'THI_CU'; // Hoặc 'LAM_NHA', tùy theo bạn định nghĩa trong DataHelper
